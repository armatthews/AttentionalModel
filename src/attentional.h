...
private:
  ...
  unsigned embedding_dim = 4; // Dimensionality of both source and target word embeddings. For now these are the same.
  unsigned half_annotation_dim = 4; // Dimensionality of h_forward and h_backward. The full h has twice this dimension.
  unsigned output_state_dim = 4; // Dimensionality of s_j, the state just before outputing target word y_j
  unsigned alignment_hidden_dim = 4; // Dimensionality of the hidden layer in the alignment FFNN
  unsigned final_hidden_dim = 4; // Dimensionality of the hidden layer in the "final" FFNN
