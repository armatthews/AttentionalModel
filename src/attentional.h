...
private:
  ...
  unsigned embedding_dim = 16; // Dimensionality of both source and target word embeddings. For now these are the same.
  unsigned half_annotation_dim = 16; // Dimensionality of h_forward and h_backward. The full h has twice this dimension.
